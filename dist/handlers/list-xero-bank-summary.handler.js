 ...
 */
async function fetchBankSummary(fromDate, toDate) {
    await xeroClient.authenticate();
    const response = await xeroClient.accountingApi.getReportBankSummary(xeroClient.tenantId, fromDate, toDate, getClientHeaders());
 ...
 */
export async function listXeroBankSummary(fromDate, toDate) {
    try {
